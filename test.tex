...
\begin{itemize}
	\item It\'eration 1: R\'ealiser tout le système de classe / level / item + réalisation d'un premier système de combat contre une IA ennemie basique.
	\item It\'eration 2: R\'ealiser la partie histoire du jeu, en d\'eveloppant les différentes IA enemies ainsi que le syst\`eme d'histoire branch\'ee.
